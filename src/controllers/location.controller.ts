...
export class LocationController {
  ...
  async create(
    @requestBody({
      content: {
        'application/json': {
          schema: getModelSchemaRef(Location, {exclude: ['id']}),
        },
      },
    })
  ...
  @get('/locations', {
    responses: {
      '200': {
        ...
        content: {
          'application/json': {
            schema: {type: 'array', items: getModelSchemaRef(Location,{includeRelations: true})},
          },
        },
      },
    },
  ...
  async find(
    ...
    console.log(filter)
    console.log(getFilterSchemaFor(Location))
  ...
  @get('/locations/{id}', {
    responses: {
      '200': {
        description: 'Location model instance',
        content: {'application/json': {schema: getModelSchemaRef(Location, {includeRelations: true})}},
      },
    },
  })
